...
export 'core/container/dev_fuick_app_page.dart';

// ── 引擎初始化 ──
export 'core/engine/engine.dart';
...
export 'core/service/file_system_service.dart' show FileSystemService;
export 'core/service/websocket_service.dart' show WebSocketService;
...
export 'offline/config/offline_config.dart';
export 'offline/domain/entities/package.dart';
export 'offline/domain/entities/bundle_manifest.dart';
