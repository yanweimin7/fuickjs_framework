...
class VideoPlayerParser extends WidgetParser {
  ...
  Widget parse(BuildContext context, Map<String, dynamic> props,
    ...
    return FuickVideoPlayer(
      ...
      onPause: asMapOrNull(props['onPause']),
...
class FuickVideoPlayerState extends State<FuickVideoPlayer>
  ...
  void _onControllerUpdate() {
    ...
    // Detect pause: was playing, now not playing and not completed
    final isPaused = !value.isPlaying && !value.isCompleted && value.isInitialized;
    if (isPaused && !_wasPaused && widget.onPause != null) {
      FuickAction.event(context, widget.onPause);
    }
    _wasPaused = isPaused;
  }
